    ...
    <section className="bg-[#faf4f0] min-h-screen px-6 py-16 text-gray-800">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        <img
          ...
          alt="Affiliate work"
          className="rounded-xl w-full h-[400px] md:h-[350px] shadow-md object-cover"
        />
        <div>
          <h3 className="text-2xl font-semibold text-[#0C3E83] mb-4">
            Why We Exist
          </h3>
      ...
      <div className="max-w-4xl mx-auto mt-20 text-center">
        <h4 className="text-2xl font-semibold text-[#0C3E83] mb-4">
